...
public final class ViewHolderProcessor extends AbstractProcessor {
  ...
  static final ClassName ONLY_ADAPTER = ClassName.get("vn.tiki.noadapter2", "OnlyAdapter");
  static final ClassName ITEM_CLICK_LISTENER = ClassName.get("vn.tiki.noadapter2", "OnItemClickListener");
  static final ClassName DIFF_CALLBACK = ClassName.get("vn.tiki.viewholders", "TypeDiffCallback");
  private Filer filer;
