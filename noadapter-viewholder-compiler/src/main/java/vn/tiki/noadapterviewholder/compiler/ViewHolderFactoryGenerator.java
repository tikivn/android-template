...
import static vn.tiki.noadapterviewholder.compiler.ViewHolderProcessor.VIEW_GROUP;
...
class ViewHolderFactoryGenerator {
  ...
  ViewHolderFactoryGenerator(final List<ViewHolderInfo> viewHolderInfoList) {
    ...
    lastViewHolderType = ClassName.get("vn.tiki.noadapterviewholder", "LastViewHolder");
  }
